...
List<KursusMateriSliderClientModelTwo> kursusMateriSliderClientModelTwoFromJson(
        String str) =>
    List<KursusMateriSliderClientModelTwo>.from(json
        .decode(str)
        .map((x) => KursusMateriSliderClientModelTwo.fromJson(x)));

String kursusMateriSliderClientModelTwoToJson(
        List<KursusMateriSliderClientModelTwo> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class KursusMateriSliderClientModelTwo {
  int id;
  ...
  KursusMateriSliderClientModelTwo({
    required this.id,
  ...
  factory KursusMateriSliderClientModelTwo.fromJson(
