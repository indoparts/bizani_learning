...
List<KursusMateriSliderClientModelOne> kursusMateriSliderClientModelOneFromJson(
        String str) =>
    List<KursusMateriSliderClientModelOne>.from(json
        .decode(str)
        .map((x) => KursusMateriSliderClientModelOne.fromJson(x)));

String kursusMateriSliderClientModelOneToJson(
        List<KursusMateriSliderClientModelOne> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class KursusMateriSliderClientModelOne {
  int id;
  ...
  KursusMateriSliderClientModelOne({
    required this.id,
  ...
  factory KursusMateriSliderClientModelOne.fromJson(
