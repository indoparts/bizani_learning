...
List<CareerModel> careerModelFromJson(String str) => List<CareerModel>.from(
    json.decode(str).map((x) => CareerModel.fromJson(x)));

String careerModelToJson(List<CareerModel> data) =>
